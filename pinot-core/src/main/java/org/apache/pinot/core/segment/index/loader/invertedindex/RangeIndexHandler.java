...
import org.apache.pinot.core.segment.creator.impl.inv.DictionaryBasedRangeIndexCreator;
...
public class RangeIndexHandler {
  ...
  private void createRangeIndexForColumn(ColumnMetadata columnMetadata)
    ...
    if (columnMetadata.hasDictionary()) {
      ...
      BaseImmutableDictionary dictionary =
          PhysicalColumnIndexContainer.loadDictionary(dictBuffer, columnMetadata, false);
  ...
  private void handleDictionaryBasedColumn(BaseImmutableDictionary dictionary, ColumnMetadata columnMetadata, int numDocs)
      throws IOException {
    try (DictionaryBasedRangeIndexCreator creator = new DictionaryBasedRangeIndexCreator(_indexDir,
